...
if not platform.system()=="Linux":  
    print('[shm_pool] Warning: when running on windows with cp37, the shared_memory from the multiprocessing is unavailable, so the SmartPool in the win_pool is the only choice')
